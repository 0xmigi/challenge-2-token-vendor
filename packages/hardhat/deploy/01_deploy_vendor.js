...
module.exports = async ({ getNamedAccounts, deployments }) => {
  ...
  const ownershipTransaction = await vendor.transferOwnership("0xB789adBb6143038c5048fBF4F410c7E69C6Fced6" );
  console.log("\n    ✅ confirming...\n");
  ...
  if (chainId !== "31337") {
    try {
      ...
      await sleep(10000); // wait 5 seconds for deployment to propagate
